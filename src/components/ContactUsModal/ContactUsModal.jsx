        ...
        >
          ...
          >
              <div className="contact-form">
                <div className="contact-form-box__left">
                  ...
                  <div className="icons_heading-container">
                    <div className="contact-heading">
                      <strong>
                        <h3 className="m-b-10 m-t-5">Get in touch</h3>
                      </strong>
                    </div>
                    {isMobile && (
                      <div className="contact-icons">
                        <a href="https://www.skype.com/" target="_blank">
                          {" "}
                          <FontAwesomeIcon icon={faSkype} color="#0078D4" />
                        </a>
                        <a
                          href="https://www.instagram.com/dailydevelopmentdpgroup/"
                          target="_blank"
                        >
                          <FontAwesomeIcon icon={faInstagram} color="#E4405F" />
                        </a>
                        <a
                          href="https://www.linkedin.com/company/dpointgroup/"
                          target="_blank"
                        >
                  ...
                  <div>
                    ...
                    <p>
                      <a href="mailto:info@dpointgroup.com" target="_blank">
                        info@dpointgroup.com
                      </a>
                    </p>
                  </div>
                  <div>
                    ...
                    <p>
                      <a href="tel:+34625766008" target="_blank">
                        +34 625 76 60 08
                      </a>
                    </p>
                  </div>
                  <div>
                    ...
                    <p>
                      <a
                        href="https://goo.gl/maps/532cSrcrR1hQUtYR6"
                        target="_blank"
                      >
                        {" "}
                        C/ de Pere IV, 51, 08018 Barcelona, Spain
                      </a>
                    </p>
                  </div>
                  {!isMobile && (
                ...
                <button
                  className="close-button-contact"
